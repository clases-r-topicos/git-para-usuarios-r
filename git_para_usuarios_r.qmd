...
**Creemos nuestro primer repositorio en RStudio y hagamos nuestros primeros commit!**
...
::: fragment
![](imagenes/no_olvidar.png){.pull-left width=25%}
...
::: fragment
**¿Qué es una rama?** Simplemente es un puntero a un `commit` específico, que contiene la información de sus ancestros. 
:::
...
Con esto debiésemos quedar al menos habilitados para un uso básico de git.
